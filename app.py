...
SEKTOR_MAP = {
    'AADI': 'BATUBARA',
    'ACST': 'KONSTRUKSI BANGUNAN',
    'ADCP': 'PENGELOLAL PENGEMBANG REAL ESTAT',
    'ADHI': 'KONSTRUKSI BANGUNAN',
    'ADMG': 'KIMIA',
    'ADMR': 'BATUBARA',
    'AGRO': 'BANK',
    'AGRS': 'BANK',
    'AHAP': 'ASURANSI',
    'AISA': 'MAKANAN OLAHAN',
    'AKSI': 'LOGISTIK PENGIRIMAN',
    'AMAN': 'PENGELOLAL PENGEMBANG REAL ESTAT',
    'AMAR': 'BANK',
    'AMIN': 'MESIN',
    'AMMN': 'LOGAM MINERAL',
    'APEX': 'PENDUKUNG MINYAK GAS BATUBARA',
    'APLN': 'PENGELOLAL PENGEMBANG REAL ESTAT',
    'ARCI': 'LOGAM MINERAL',
    'ARII': 'BATUBARA',
    'ARKO': 'UTILITAS LISTRIK',
    'ARTO': 'BANK',
    'ASLC': 'RITEL KHUSUS',
    'ATAP': 'PENGELOLAL PENGEMBANG REAL ESTAT',
    'ATLA': 'PENDUKUNG MINYAK GAS BATUBARA',
    'AXIO': 'PERANGKAT KOMPUTER',
    'AYLS': 'MATERIAL KONSTRUKSI',
    'BABP': 'BANK',
    'BABY': 'RITEL KHUSUS',
    'BACA': 'BANK',
    'BAJA': 'LOGAM MINERAL',
    'BANK': 'BANK',
    'BAPA': 'PENGELOLAL PENGEMBANG REAL ESTAT',
    'BATR': 'MATERIAL KONSTRUKSI',
    'BBHI': 'BANK',
    'BBRI': 'BANK',
    'BBRM': 'BATUBARA',
    'BBSS': 'PENGELOLAL PENGEMBANG REAL ESTAT',
    'BBYB': 'BANK',
    'BCAP': 'PERUSAHAAN INDUK DAN INVESTASI',
    'BCIP': 'PENGELOLAL PENGEMBANG REAL ESTAT',
    'BEER': 'MINUMAN',
    'BELL': 'PAKAIAN BARANG MEWAH',
    'BEST': 'PENGELOLAL PENGEMBANG REAL ESTAT',
    'BGTG': 'BANK',
    'BIMA': 'PAKAIAN BARANG MEWAH',
    'BIPI': 'BATUBARA',
    'BKSW': 'BANK',
    'BNII': 'BANK',
    'BOAT': 'PENDUKUNG MINYAK GAS BATUBARA',
    'BOBA': 'MAKANAN OLAHAN',
    'BOLA': 'PARIWISATA DAN REKREASI',
    'BREN': 'UTILITAS LISTRIK',
    'BRIS': 'BANK',
    'BRMS': 'LOGAM MINERAL',
    'BRPT': 'KIMIA',
    'BRRC': 'MAKANAN OLAHAN',
    'BSBK': 'PENGELOLAL PENGEMBANG REAL ESTAT',
    'BUMI': 'BATUBARA',
    'BUVA': 'PARIWISATA DAN REKREASI',
    'BVIC': 'BANK',
    'CAKK': 'PRODUK PERLENGKAPAN BANGUNGAN',
    'CARS': 'RITEL KHUSUS',
    'CBDK': 'PENGELOLAL PENGEMBANG REAL ESTAT',
    'CENT': 'JASA TELKOM NIRKABEL',
    'CGAS': 'MINYAKGAS',
    'CHEM': 'KIMIA',
    'CINT': 'BARANG RUMAH TANGGA',
    'CITY': 'PENGELOLAL PENGEMBANG REAL ESTAT',
    'COCO': 'MAKANAN OLAHAN',
    'CRSN': 'JASA PROFESIONAL',
    'CSIS': 'PENGELOLAL PENGEMBANG REAL ESTAT',
    'CUAN': 'BATUBARA',
    'DAAZ': 'LOGAM MINERAL',
    'DATA': 'JASA TELELKOMUNIKASI',
    'DEWA': 'PENDUKUNG MINYAK GAS BATUBARA',
    'DEWI': 'PRODUK MAKANAN PERTANIAN',
    'DFAM': 'PARIWISATA DAN REKREASI',
    'DGIK': 'KONSTRUKSI BANGUNAN',
    'DGNS': 'PENYEDIA JASA KESEHATAN',
    'DIVA': 'APLIKASI JASA INTERNET',
    'DKFT': 'LOGAM MINERAL',
    'DMMX': 'JASA KONSULTAN TEKNOLOGI INFORMASI',
    'DNAR': 'BANK',
    'DOOH': 'MEDIA',
    'DOSS': 'BARANG ELEKTRONIK KONSUMEN',
    'DPUM': 'PRODUK MAKANAN PERTANIAN',
    'DSFI': 'PRODUK MAKANAN PERTANIAN',
    'DYAN': 'JASA KOMERSIL',
    'EAST': 'PARIWISATA DAN REKREASI',
    'ELIT': 'JASA KONSULTAN TEKNOLOGI INFORMASI',
    'ELSA': 'PENDUKUNG MINYAK GAS BATUBARA',
    'EMTK': 'APLIKASI JASA INTERNET',
    'ENRG': 'MINYAKGAS',
    'ERTX': 'PAKAIAN BARANG MEWAH',
    'ESSA': 'KIMIA',
    'ESTA': 'PARIWISATA DAN REKREASI',
    'ESTI': 'KIMIA',
    'EURO': 'PRODUK PERAWATAN TUBUH',
    'EXCL': 'JASA TELKOM NIRKABEL',
    'FAST': 'MAKANAN OLAHAN',
    'FILM': 'HIBURAN DAN FILM',
    'FIRE': 'BATUBARA',
    'FITT': 'PARIWISATA DAN REKREASI',
    'FOLK': 'PERINDUSTRIAN INDUK MULTI SEKTOR',
    'FORE': 'MINUMAN',
    'FUJI': 'PEMBIAYAAN KONSUMEN',
    'FUTR': 'MEDIA',
    'FWCT': 'PERHUTANAN KERTAS',
    'GEMA': 'BARANG RUMAH TANGGA',
    'GJTL': 'OTOMOTIF',
    'GOLF': 'PARIWISATA DAN REKREASI',
    'GOTO': 'APLIKASI JASA INTERNET',
    'GPSO': 'MESIN',
    'GRIA': 'PENGELOLAL PENGEMBANG REAL ESTAT',
    'GSMF': 'PERUSAHAAN INDUK DAN INVESTASI',
    'GTBO': 'BATUBARA',
    'GTRA': 'LOGISTIK PENGIRIMAN',
    'GTSI': 'MINYAKGAS',
    'GULA': 'MAKANAN OLAHAN',
    'GZCO': 'PRODUK MAKANAN PERTANIAN',
    'HAIS': 'LOGISTIK PENGIRIMAN',
    'HAJJ': 'PARIWISATA DAN REKREASI',
    'HALO': 'PERALATAN PERLENGKAPAN KESEHATAN',
    'HDFA': 'PEMBIAYAAN KONSUMEN',
    'HDIT': 'APLIKASI JASA INTERNET',
    'HELI': 'LOGISTIK PENGIRIMAN',
    'HOKI': 'MAKANAN OLAHAN',
    'HRTA': 'PAKAIAN BARANG MEWAH',
    'HUMI': 'MINYAKGAS',
    'IATA': 'BATUBARA',
    'ICON': 'JASA KOMERSIL',
    'INDX': 'JASA PROFESIONAL',
    'INDY': 'BATUBARA',
    'INET': 'JASA TELELKOMUNIKASI',
    'INKP': 'PERHUTANAN KERTAS',
    'INOV': 'PAKAIAN BARANG MEWAH',
    'INPC': 'BANK',
    'IOTF': 'PERANGKAT INSTRUMEN KOMP ELEKTRONIK',
    'IRRA': 'PERALATAN PERLENGKAPAN KESEHATAN',
    'ISEA': 'PRODUK MAKANAN PERTANIAN',
    'ITMA': 'PENDUKUNG MINYAK GAS BATUBARA',
    'JARR': 'PRODUK MAKANAN PERTANIAN',
    'JAST': 'JASA TELELKOMUNIKASI',
    'JATI': 'APLIKASI JASA INTERNET',
    'JAWA': 'PRODUK MAKANAN PERTANIAN',
    'JAYA': 'LOGISTIK PENGIRIMAN',
    'JKON': 'KONSTRUKSI BANGUNAN',
    'JMAS': 'ASURANSI',
    'KAEF': 'FARMASI',
    'KAQI': 'OTOMOTIF',
    'KBLV': 'JASA TELELKOMUNIKASI',
    'KICI': 'BARANG RUMAH TANGGA',
    'KIOS': 'APLIKASI JASA INTERNET',
    'KJEN': 'LOGISTIK PENGIRIMAN',
    'KKES': 'KIMIA',
    'KLAS': 'LOGISTIK PENGIRIMAN',
    'KOCI': 'PENGELOLAL PENGEMBANG REAL ESTAT',
    'KOKA': 'KONSTRUKSI BANGUNAN',
    'KPIG': 'PARIWISATA DAN REKREASI',
    'KRAS': 'LOGAM MINERAL',
    'KRYA': 'KONSTRUKSI BANGUNAN',
    'KSIX': 'PENGELOLAL PENGEMBANG REAL ESTAT',
    'KUAS': 'PRODUK PERLENGKAPAN BANGUNGAN',
    'LABA': 'MESIN',
    'LAJU': 'LOGISTIK PENGIRIMAN',
    'LEAD': 'MINYAKGAS',
    'LIVE': 'BARANG RUMAH TANGGA',
    'LPKR': 'PENGELOLAL PENGEMBANG REAL ESTAT',
    'LPPS': 'PERUSAHAAN INDUK DAN INVESTASI',
    'LUCK': 'PERANGKAT KOMPUTER',
    'MAPI': 'RITEL KHUSUS',
    'MAXI': 'MAKANAN OLAHAN',
    'MAYA': 'BANK',
    'MBMA': 'LOGAM MINERAL',
    'MBSS': 'BATUBARA',
    'MBTO': 'PRODUK PERAWATAN TUBUH',
    'MCOR': 'BANK',
    'MDKA': 'LOGAM MINERAL',
    'MDLA': 'FARMASI',
    'MDLN': 'PENGELOLAL PENGEMBANG REAL ESTAT',
    'MEDC': 'MINYAKGAS',
    'MEDS': 'PERALATAN PERLENGKAPAN KESEHATAN',
    'MERI': 'PENDIDIKAN DAN JASA PENUNJANG',
    'MITI': 'MINYAKGAS',
    'MKTR': 'PRODUK MAKANAN PERTANIAN',
    'MMIX': 'PERALATAN PERLENGKAPAN KESEHATAN',
    'MOLI': 'KIMIA',
    'MPIX': 'APLIKASI JASA INTERNET',
    'MPOW': 'UTILITAS LISTRIK',
    'MPXL': 'LOGISTIK PENGIRIMAN',
    'MSIE': 'PENGELOLAL PENGEMBANG REAL ESTAT',
    'MSIN': 'HIBURAN DAN FILM',
    'MSKY': 'MEDIA',
    'MTWI': 'ASURANSI',
    'MUTU': 'JASA PROFESIONAL',
    'NASI': 'MAKANAN OLAHAN',
    'NCKL': 'LOGAM MINERAL',
    'NEST': 'MAKANAN OLAHAN',
    'NETV': 'MEDIA',
    ...
    'NOBU': 'BANK',
    'NTBK': 'MESIN',
    'NZIA': 'PENGELOLAL PENGEMBANG REAL ESTAT',
    'OASA': 'JASA TELKOM NIRKABEL',
    'OBMD': 'KIMIA',
    'OILS': 'PRODUK MAKANAN PERTANIAN',
    'OKAS': 'KIMIA',
    'OPMS': 'LOGAM MINERAL',
    'PAMG': 'PENGELOLAL PENGEMBANG REAL ESTAT',
    'PANI': 'MAKANAN OLAHAN',
    'PART': 'OTOMOTIF',
    'PGEO': 'UTILITAS LISTRIK',
    'PICO': 'WADAH KEMASAN',
    'PMJS': 'RITEL KHUSUS',
    'PNBS': 'BANK',
    'PPRI': 'WADAH KEMASAN',
    'PRIM': 'PENYEDIA JASA KESEHATAN',
    'PSAB': 'LOGAM MINERAL',
    'PSDN': 'MAKANAN OLAHAN',
    'PTMP': 'MESIN',
    'PTPS': 'PRODUK MAKANAN PERTANIAN',
    'PTRO': 'PENDUKUNG MINYAK GAS BATUBARA',
    'PURI': 'PENGELOLAL PENGEMBANG REAL ESTAT',
    'RAAM': 'HIBURAN DAN FILM',
    'RAJA': 'MINYAKGAS',
    'RATU': 'MINYAKGAS',
    'RBMS': 'PENGELOLAL PENGEMBANG REAL ESTAT',
    'RCCC': 'LOGISTIK PENGIRIMAN',
    'RGAS': 'PENDUKUNG MINYAK GAS BATUBARA',
    'RICY': 'PAKAIAN BARANG MEWAH',
    'RMKE': 'BATUBARA',
    'RMKO': 'PENDUKUNG MINYAK GAS BATUBARA',
    'RUIS': 'PENDUKUNG MINYAK GAS BATUBARA',
    'SAME': 'PENYEDIA JASA KESEHATAN',
    'SDMU': 'LOGISTIK PENGIRIMAN',
    'SEMA': 'BAHAN BAKAR ALTERNATIF',
    'SGER': 'BATUBARA',
    'SICO': 'PENDUKUNG MINYAK GAS BATUBARA',
    'SLIS': 'RITEL KHUSUS',
    'SMBR': 'MATERIAL KONSTRUKSI',
    'SMDR': 'LOGISTIK PENGIRIMAN',
    'SMGA': 'LOGAM MINERAL',
    'SMIL': 'MESIN',
    'SMLE': 'KIMIA',
    'SMMT': 'BATUBARA',
    'SOCI': 'MINYAKGAS',
    'SOLA': 'MATERIAL KONSTRUKSI',
    'SQMI': 'LOGAM MINERAL',
    'SRSN': 'KIMIA',
    'SSIA': 'KONSTRUKSI BANGUNGAN',
    'SULI': 'PERHUTANAN KERTAS',
    'SURI': 'PERALATAN PERLENGKAPAN KESEHATAN',
    'TAYS': 'MAKANAN OLAHAN',
    'TGUK': 'MAKANAN OLAHAN',
    'TINS': 'LOGAM MINERAL',
    'TMAS': 'LOGISTIK PENGIRIMAN',
    'TMPO': 'MEDIA',
    'TNCA': 'LOGISTIK PENGIRIMAN',
    'TOBA': 'BATUBARA',
    'TOOL': 'RITEL KHUSUS',
    'TOSK': 'APLIKASI JASA INTERNET',
    'TRIN': 'PENGELOLAL PENGEMBANG REAL ESTAT',
    'TRIS': 'PAKAIAN BARANG MEWAH',
    'TRJA': 'TRANSPORTASI PENUMPANG DARAT',
    'TRUK': 'LOGISTIK PENGIRIMAN',
    'UFOE': 'RITEL KHUSUS',
    'UVCR': 'APLIKASI JASA INTERNET',
    'VICO': 'PERUSAHAAN INDUK DAN INVESTASI',
    'VKTR': 'OTOMOTIF',
    'VTNY': 'PEMBIAYAAN KONSUMEN',
    'WAPO': 'PRODUK MAKANAN PERTANIAN',
    'WEGE': 'KONSTRUKSI BANGUNAN',
    'WIFI': 'APLIKASI JASA INTERNET',
    'WIRG': 'PERANGKAT LUNAK',
    'WOWS': 'PENDUKUNG MINYAK GAS BATUBARA',
    'WTON': 'MATERIAL KONSTRUKSI',
    'ZATA': 'RITEL KHUSUS',
    'ZBRA': 'PERINDUSTRIAN INDUK MULTI SEKTOR',
    'ZYRX': 'PERANGKAT KOMPUTER',
}
...
def scan_above_ma20_spike(all_ohlcv, target, lookback_days=15, spike_threshold=8.0, vol_dry_ratio=7.0):
    ...
    for code, bars in all_ohlcv.items():
        ...
        spike_days = []
        for b in window:
            if b.get('P') and b['P'] > 0 and b.get('C'):
                c = (b['C'] - b['P']) / b['P'] * 100
                if c >= spike_threshold:
                    spike_days.append(b)
        if not spike_days: continue

        best_spike = max(spike_days, key=lambda b: b.get('V', 0))
        vol_spike = best_spike.get('V', 0)
        vol_today = today.get('V', 0)
        if vol_spike <= 0: continue
        vol_ratio_pct = vol_today / vol_spike * 100
...
def scan_bersih2(all_ohlcv, avg_vols, target, chg_min=3.0, chg_max=9.0,
    ...
    for code, bars in all_ohlcv.items():
        ...
        today = bars[-1]
        if not today.get('P') or today['P'] <= 0: continue
        chg0 = (today['C'] - today['P']) / today['P'] * 100
        if not (chg_min <= chg0 <= chg_max): continue

        window = bars[-(lookback_days + 1):-1]  # 30 hari SEBELUM hari ini
        max_prior_chg = 0.0
        for b in window:
            if b.get('P') and b['P'] > 0:
                c = (b['C'] - b['P']) / b['P'] * 100
...
def build_trackrecord_bersih2(all_ohlcv, all_dates, lookback_days=30,
                               tp1_pct=5.0, tp2_pct=13.0):
    """TrackRecord khusus Scan Bersih v2 — TANPA SL. Lacak, buat tiap entry
    historis, di hari ke berapa (H+n) High pertama kali menyentuh TP1(5%) dan
    TP2(13%) dari Close saat entry. '-' kalau belum pernah tercapai sampai
    data terakhir yang ada."""
    dates_sorted = sorted(all_dates)
    records = []
    for i, date_t in enumerate(dates_sorted):
        ohlcv_t = truncate_ohlcv_to_date(all_ohlcv, date_t)
        entries = [e for e in scan_bersih2(ohlcv_t, {}, date_t, lookback_days=lookback_days) if e['in_wl']]
        if not entries: continue
        future_dates = dates_sorted[i+1:]
        for r in entries:
            code = r['code']; close_entry = r['close']
            bars = all_ohlcv.get(code, [])
            tp1_price = close_entry * (1 + tp1_pct/100)
            tp2_price = close_entry * (1 + tp2_pct/100)
            tp1_day = None; tp2_day = None
            for j, fd in enumerate(future_dates, start=1):
                bar_f = next((b for b in bars if b['date'] == fd), None)
                if not bar_f or not bar_f.get('H'): continue
                if tp1_day is None and bar_f['H'] >= tp1_price:
                    tp1_day = j
                if tp2_day is None and bar_f['H'] >= tp2_price:
                    tp2_day = j
                if tp1_day and tp2_day: break
            records.append({
                'Tanggal Entry': date_t, 'Code': code, 'Close Entry': close_entry,
                f'TP1 {tp1_pct:.0f}%': f'H+{tp1_day}' if tp1_day else '-',
                f'TP2 {tp2_pct:.0f}%': f'H+{tp2_day}' if tp2_day else '-',
            })
    records.sort(key=lambda x: x['Tanggal Entry'], reverse=True)
    return records
    ...
    with tabs[7]:
        ...
        if lst_ma20:
            ...
            ma20_tbl_html = (
                ...
                '<th style="padding:7px 10px;text-align:right;color:#666;font-weight:400;font-size:11px">Close</th>'
                '<th style="padding:7px 10px;text-align:right;color:#666;font-weight:400;font-size:11px">Chg%</th>'
                '<th style="padding:7px 10px;text-align:right;color:#666;font-weight:400;font-size:11px">MA20</th>'
                '<th style="padding:7px 10px;text-align:left;color:#666;font-weight:400;font-size:11px">Tgl Spike</th>'
                '<th style="padding:7px 10px;text-align:right;color:#666;font-weight:400;font-size:11px">Vol vs Spike</th>'
                '<th style="padding:7px 10px;text-align:center;color:#666;font-weight:400;font-size:11px">Status</th>'
    ...
    with tabs[22]:
        ...
        if not calendar_data:
            ...
            def _heat_color(n):
                ...
                elif ratio < 0.75: return ('#15803d', '#22c55e')
                else: return ('#065f46', '#10b981')
            ...
            for (year, month) in sorted(_months_data.keys(), reverse=True):
                ...
                header_html = ''.join(f'<div style="text-align:center;font-size:13px;color:#888;padding:4px">{d}</div>' for d in day_names)
                cells_html = ''
                ...
                for day in range(1, n_days + 1):
                    ...
                    if not is_trading:
                        cells_html += (
                            '<div style="background:transparent;border-radius:6px;padding:6px 4px;min-height:80px;'
                            'border:1px solid rgba(255,255,255,0.02)">'
                            f'<div style="font-size:13px;color:#333">{day}</div></div>'
                        )
                        continue
                    bg, fg = _heat_color(n)
                    top_codes = ', '.join(e['code'] for e in entries[:5]) if entries else ''
                    cells_html += (
                        f'<div style="background:{bg};border-radius:6px;padding:6px 4px;min-height:80px;'
                        f'border:1px solid rgba(255,255,255,0.08)">'
                        f'<div style="font-size:13px;color:#ccc">{day}</div>'
                        + (f'<div style="font-size:19px;font-weight:700;color:{fg}">{n}</div>' if n > 0 else '<div style="font-size:19px;font-weight:700;color:#444">0</div>')
                        + (f'<div style="font-size:11px;color:{fg};opacity:0.9;line-height:1.4">{top_codes}</div>' if top_codes else '')
                        + '</div>'
                    )
                st.html(
